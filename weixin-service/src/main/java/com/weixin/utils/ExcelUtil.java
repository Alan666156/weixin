...
public class ExcelUtil {
     ...
     *            文件输出流
     * @param pattern 
     *            设定时间类型输出格式。默认为"yyyy-MM-dd" 
     */  
	public static <T> boolean exportExcel(String fileName, String[] headers, Collection<T> dataset, HttpServletRequest request, HttpServletResponse response , String pattern) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		// 声明一个工作薄
